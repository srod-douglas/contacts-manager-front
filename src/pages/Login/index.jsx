...
const Login = () => {
    ...
    return(
        <>
            <main id='login' className='bg-main bg-cover container flex flex-col h-full max-h-screen max-w-full justify-center m-0 select-none' >
                    
                <section className='flex flex-col h-2/3 max-h-screen max-w-full w-full justify-center items-center'>
                    <form noValidate onSubmit={handleSubmit(submit)} className='backdrop-blur-md w-3/12 container flex flex-col justify-around  h-full max-h-screen p-6  shadow-2xl shadow-black rounded-xl'>
                    ...
                    <div className='flex justify-center gap-1 place-items-center text-center'>
                        ...
                        <input placeholder='password' type={view ? 'text' : 'password'} {...register('password')} className='h-12 pl-3 placeholder-gray-500  rounded bg-neutral-950 outline-none text-gray-300 ring-black caret-slate-500' />
                        ...
                        <button type='submit' className='h-12 w-full text-gray-300 self-center bg-gradient-to-t from-neutral-500 opacity-50 hover:opacity-100 rounded-xl'>login</button>
