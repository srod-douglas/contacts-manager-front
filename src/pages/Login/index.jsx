        ...
        <>
            <main id='login' className='container flex flex-col h-full max-h-screen max-w-full justify-center m-0 bg-gradient-to-t from-slate-950 to-slate-700'>
                ...
                <section className='flex flex-col h-2/3 max-h-screen max-w-full w-full justify-center items-center'>
                    <form noValidate onSubmit={handleSubmit(submit)} className=' w-3/12 container flex flex-col justify-around  h-full max-h-screen p-6 bg-slate-800 drop-shadow-2xl rounded-xl'>
                    ...
                    <div className='flex justify-center gap-1 place-items-center text-center'>
                            ...
                            <h4  className='mt-1 text-center text-gray-300 sm:text-base font-thin dark:text-slate-200 opacity-90 tracking-widest'> login</h4>
                        </div>
